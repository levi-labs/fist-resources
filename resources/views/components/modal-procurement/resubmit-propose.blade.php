<div class="modal fade" id="resubmitModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="resubmit-form" action="{{ route('propose.inventory.resubmitteddetail', $params) }}"
                method="POST">
...
<script>
    ...
    $(document).ready(function() {
        console.log('Selamat datang jquery resubmit!');
        $('#resubmit-form').submit(function(e) {
            ...
            $.ajax({
                type: 'PUT',
                url: "{{ route('propose.inventory.resubmitteddetail', $params) }}",
                data: {
                    "reason": reason,
                    "_token": csrf_token
                },
