<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="approve-form" action="{{ route('propose.inventory.approvedetail', $params) }}" method="POST">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="reason" class="form-label">Reasons for propose :</label>
...
<script>
    ...
    $(document).ready(function() {
        console.log('Selamat datang jquery propose!');
        $('#approve-form').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('propose.inventory.approvedetail', $params) }}",
                data: {
