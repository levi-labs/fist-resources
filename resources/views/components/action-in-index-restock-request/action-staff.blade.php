<div class="flex align-items-center list-user-action">
    <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="top"
        href="{{ route('restock.inventory.show', $restock->request_code) }}" aria-label="Detail"
    ...
    @php
        $restock = \App\Models\RestockInventory::where('request_code', $restock->request_code)->first();
        $status = $restock->status;
    @endphp
    @if ($status !== 'approved' && $status !== 'rejected')
        <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top"
            data-original-title="Edit" href="{{ route('restock.inventory.edit', $restock->request_code) }}"
        ...
        <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top"
            href="{{ route('restock.inventory.destroy', $restock->request_code) }}" aria-label="Delete"
