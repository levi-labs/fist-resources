                    ...
                    <div class="card-body px-0">
                        <div class="table-responsive">
                            <table id="user-list-table" class="table table-striped" role="grid"
                                ...
                                <tbody>
                                    @forelse ($propose_products as $product)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-sm btn-success"
                                                    href="{{ route('propose.inventory.updateAddItem', ['id' => $product->id, 'request_code' => $proposed[0]->request_code]) }}">Add</a>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action="{{ route('propose.inventory.update', $proposed[0]->request_code) }}" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="row p-4">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="notes" rows="2" name="notes">{{ old('notes', $proposed[0]->notes) }}</textarea>
                                    @error('notes')
