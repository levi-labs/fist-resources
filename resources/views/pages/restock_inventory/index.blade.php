                                            ...
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip"
                                                        ...
                                                        href="{{ route('restock.inventory.show', $restock->request_code) }}"
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        href="{{ route('restock.inventory.destroy', $restock->request_code) }}"
...
{{-- <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top"
    data-original-title="Edit" href="{{ route('user.edit', $restock->request_code) }}" aria-label="Edit"
