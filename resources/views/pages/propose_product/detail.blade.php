        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="row p-4">
                        <div class="col-md-4">
                            <a href="{{ route('propose.product.index') }}" class="btn btn-primary btn-sm">Back</a>
                        </div>
                        <div class="col-md-8 text-end">
                            <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top"
                                data-original-title="Edit" href="{{ route('propose.product.edit', $propose->id) }}"
                            ...
                            <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top"
                                href="{{ route('product.destroy', $propose->id) }}" aria-label="Delete"
                    ...
                    <div class="card-body px-0">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-body">
                                        <img class="img-fluid" src="{{ $propose->image }}" alt="Product Image">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">{{ ucfirst($propose->name) }} |
                                            {{ formatNumber($propose->price) }}</h4>
                                    </div>
                                    <div class="card-body">
                                        <table class="table table-borderless">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $propose->category->name ?? '-' }}</td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Price</th>
                                                    <td>{{ formatNumber($propose->price) }}</td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Description</th>
                                                    <td class="text-wrap">{{ $propose->description }}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
