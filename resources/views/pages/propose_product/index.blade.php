            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="float-end">
                            <form action="{{ route('propose.product.search') }}" method="POST">
                                @csrf
                    ...
                    <div class="row p-4">
                        <div class="col-sm-12">
                            <a href="{{ route('propose.product.create') }}" class="btn btn-primary btn-sm">Add
                                New</a>
                        </div>
                    </div>
                    <div class="card-body px-0">
                        <div class="table-responsive">
                            <table id="user-list-table" class="table table-striped" role="grid"
                                ...
                                <tbody>
                                    @forelse ($propose_products as $propose)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip"
                                                        ...
                                                        href="{{ route('propose.product.edit', $propose->id) }}"
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip"
                                                        ...
                                                        href="{{ route('propose.product.destroy', $propose->id) }}"
