            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div class="header-title">
                            ...
                            <div class="row">
                                <div class="col-md-12 mt-2">
                                    <a href="{{ route('shipment.proposeShipped') }}"
                                        class="btn btn-outline-secondary btn-sm {{ request()->routeIs('shipment.proposeShipped*') ? 'my-active' : '' }}">Shipped</a>
                                    <a href="{{ route('shipment.proposeDelivered') }}"
                                        class="btn btn-outline-secondary btn-sm {{ request()->routeIs('shipment.proposeDelivered*') ? 'my-active' : '' }}">Delivered</a>
                        ...
                        <div class="float-end">
                            <form action="{{ route('shipment.proposeShippedsearch') }}" method="POST">
                                @csrf
